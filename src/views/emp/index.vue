    ...
    <template>
      ...
      >
        ...
        <el-table-column align="center" label="职位">
          <template slot-scope="scope">
            <span v-if="scope.row.job == 1" style="margin-right: 10px"
              >班主任</span
            >
            <span v-if="scope.row.job == 2" style="margin-right: 10px"
              >讲师</span
            >
            <span v-if="scope.row.job == 3" style="margin-right: 10px"
              >学工主管</span
            >
            <span v-if="scope.row.job == 4" style="margin-right: 10px"
              >教研主管</span
            >
          </template>
        </el-table-column>
